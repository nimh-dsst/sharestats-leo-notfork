...
class OddpubMetrics(Base):
    ...
    id = Column(Integer, primary_key=True)
    article = Column(String, unique=True, nullable=False, index=True)
    is_open_data = Column(Boolean, nullable=False, default=False)
    open_data_category = Column(String)
    is_reuse = Column(Boolean, nullable=False, default=False)
    is_open_code = Column(Boolean, nullable=False, default=False)
    is_open_data_das = Column(Boolean, nullable=False, default=False)
    is_open_code_cas = Column(Boolean, nullable=False, default=False)
    das = Column(String)
